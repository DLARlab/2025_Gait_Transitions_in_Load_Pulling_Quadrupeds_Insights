function SLIP_Graphics_Quadruped_GUI()
    clc;
    ...
    % Index input
    uilabel(fig, 'Text', 'Solution Index:', ...
        'Position', [0.06*screenSize(4) + buttonWidth + dropdownWidth + 0.05*buttonWidth, topY, 1.00*buttonWidth, buttonHeight]);
    indexInput = uieditfield(fig, 'numeric', ...
        'Position', [0.06*screenSize(4) + buttonWidth + dropdownWidth + 1.06*buttonWidth, topY, 0.5*buttonWidth, buttonHeight], ...
        'ValueChangedFcn', @(src, event) InitializePlots());
    numSolutionsLabel = uilabel(fig, 'Text', ' / Nah', ...
        'Position', [0.06*screenSize(4) + buttonWidth + dropdownWidth + 1.57*buttonWidth, topY, 0.5*buttonWidth, buttonHeight]);
